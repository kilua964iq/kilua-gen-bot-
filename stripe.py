...
def st1(ccx):
	...
	link = "https://www.marinadentistry.com"
	...
	final_headers = {'Content-Type': 'application/x-www-form-urlencoded', 'Referer': f'https://www.marinadentistry.com/my-account/add-payment-method/', 'Origin': f'https://www.marinadentistry.com', 'user-agent': user}
